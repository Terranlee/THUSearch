...
public class shutdown_jsp extends HttpJspBase {
 ...
 if(shutdown){ 
      out.write("\n        ");
      out.write("<p> \n            ");
      out.write("<b>Heritrix software has been shut down!");
      out.write("</b>\n        ");
      out.write("<p>\n            This web access is no longer functioning. The software must \n            be relaunched via command line for it to be accessible again.\n        ");
      out.write("<p>\n            ");
      out.write("<i>Thank you for using Heritrix");
      out.write("</i>\n    ");
 } else { 
      out.write("        \n        ");
      out.write("<script type=\"text/javascript\">\n            function doShutDown(){\n                if (confirm(\"Shut Heritrix software down?\")){\n                    document.frmShutDown.shutdown.value = \"doit\";\n                    document.frmShutDown.submit();\n                }\n            }\n        ");
      out.write("</script>\n        \n        ");
      out.write("<form name=\"frmShutDown\" method=\"post\" action=\"shutdown.jsp\">\n            ");
      out.write("<input type=\"hidden\" name=\"shutdown\">\n        ");
      out.write("</form>\n    \n        ");
      out.write("<p>\n            ");
      out.write("<b>Are you sure you wan't to shut Heritrix down?");
      out.write("</b>\n        ");
      out.write("<p>\n            ");
      out.write("<span class=\"warning\">");
      out.write("<b>Warning:");
      out.write("</b> Doing so will end any current job \n            and terminate this web access.");
      out.write("<br> The program can only be restarted via\n            command line launching");
      out.write("</span>\n        ");
      out.write("<p>\n            ");
      out.write("<input type=\"button\" value=\"I'm sure, shut it down\" onClick=\"doShutDown()\">\n            ");
      out.write("<input type=\"button\" value=\"Cancel\" onClick=\"document.location='");
      out.print(request.getContextPath());
      out.write("/index.jsp'\">\n\n    ");
 } 
      out.write("\n");
