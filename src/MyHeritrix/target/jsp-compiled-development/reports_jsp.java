...
public class reports_jsp extends HttpJspBase {
 ...
 if(message != null ){ 
      ...
      out.write("</p>\n");
      out.write("<p>\n");
      out.write("<b>Reports on ongoing crawl/current status");
      out.write("</b>");
      out.write("<br>\n");
      out.write("<ul>\n\t");
 if(handler.getCurrentJob() != null) { 
      ...
      out.write("<a href=\"");
      out.print(request.getContextPath());
      out.write("/reports/crawljob.jsp\">Crawl report");
      out.write("</a>");
      out.write("</li>\n    ");
      out.write("<li>");
      out.write("<a href=\"");
      ...
      out.write("\">Seed report");
      out.write("</a>");
      out.write("</li>\n    ");
 } else { 
      out.write("\n    ");
      out.write("<li>Crawl report (unavailable)");
      out.write("</li>\n    ");
      out.write("<li>Seed report (unavailable)");
      out.write("</li>\n    ");
 } 
      out.write("\n\t");
 if(handler.getCurrentJob() != null) { 
      ...
      out.write("<a href=\"");
      out.print(request.getContextPath());
      out.write("/reports/frontier.jsp\">Frontier report");
      out.write("</a>");
      out.write("<br>\n     ");
      out.print(handler.getCurrentJob() != null?
        handler.getCurrentJob().getFrontierOneLine(): "");
      out.write("</li>\n    ");
 } else { 
      out.write("\n    ");
      out.write("<li>Frontier report (unavailable)");
      out.write("</li>\n    ");
 } 
      out.write("\n    ");
 if(handler.isCrawling()) { 
      ...
      out.write("<a href=\"");
      out.print(request.getContextPath());
      out.write("/reports/processors.jsp\">Processors report");
      out.write("</a>");
      out.write("</li>\n    ");
 } else { 
      out.write("\n    ");
      out.write("<li>Processors report (unavailable)");
      out.write("</li>\n    ");
 } 
      out.write("\n    ");
 if(handler.isCrawling()) { 
      ...
      out.write("<a href=\"");
      out.print(request.getContextPath());
      out.write("/reports/threads.jsp\">ToeThread report");
      out.write("</a>");
      out.write("<br>\n     ");
      out.print((handler.getCurrentJob() != null)?
        handler.getCurrentJob().getThreadOneLine():"" );
      out.write("</li>\n    ");
 } else { 
      out.write("\n    ");
      out.write("<li>ToeThread report (unavailable)");
      out.write("</li>\n    ");
 } 
      out.write("\n");
      out.write("</ul>\n");
 if(handler.getCurrentJob() != null) { 
      out.write("\n");
      out.write("<p>The crawler generates reports when it finishes a job.  Clicking here on ");
      out.write("<a href=\"");
      out.print(request.getContextPath());
      ...
      out.write("=");
      out.print(FORCE);
      out.write("\">Force generation of end-of-crawl Reports");
      out.write("</a> will force the writing of reports to disk.  Clicking this link will return you to this page. Look to the disk for the generated reports.  Each click overwrites previously generated reports. Use this facility when the crawler has hung threads that can't be interrupted.");
      out.write("</p>\n");
 } 
      out.write("\n\n");
      ...
      out.write("<b>Started crawl jobs");
      out.write("</b> (newest to oldest)\n        ");
      out.write("</td>\n    ");
 if (crawling == false && jobs.size() == 0) { 
      out.write("\n        ");
      out.write("<tr>\n            ");
      out.write("<td>&nbsp;No crawl jobs have been started");
      out.write("</td>\n        ");
      out.write("</tr>\n    ");
 } else { 
      out.write("\n        ");
  if(crawling){ 
      ...
      out.write("<td>\n                       ");
      out.write("<i>");
      out.print(handler.getCurrentJob().getStatus());
      out.write("</i>&nbsp;&nbsp;\n                    ");
      out.write("</td>\n                ");
      out.write("</tr>\n        ");
